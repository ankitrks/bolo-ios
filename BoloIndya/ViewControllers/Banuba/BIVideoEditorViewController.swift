//
//  BIVideoEditorViewController.swift
//  BoloIndya
//
//  Created by Rahul Garg on 04/01/21.
...
final class BIVideoEditorViewController: BaseVC {
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        if isLogin() {
            videoEditor?.presentVideoEditor(from: self, animated: true, completion: nil)
        }
    }
    ...
    private func initVideoEditor() {
        ...
        videoEditor = BanubaVideoEditor(
            token: Constants.Keys.banubaClientKey,
            effectsToken: Constants.Keys.banubaEffectsKey,
            configuration: config,
            analytics: nil,
            externalViewControllerFactory: viewControllerFactory
        )
        
        musicEditorViewControllerFactory.videoEditorSDK = videoEditor
...
extension BIVideoEditorViewController: BanubaVideoEditorDelegate {
    func videoEditorDidCancel(_ videoEditor: BanubaVideoEditor) {
        videoEditor.dismissVideoEditor(animated: false, completion: {
...
extension BIVideoEditorViewController: TrackSelectionViewControllerDelegate {
    func trackSelectionViewController(viewController: TrackSelectionViewController, didSelectFile url: URL, title: String, id: Int64) {
        print(url)
    }
