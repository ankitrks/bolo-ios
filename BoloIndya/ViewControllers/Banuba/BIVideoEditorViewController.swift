...
//        let url = wavFiles?.first?.absoluteURL
//        do {
//            try videoEditor?.sdk.audioService.load(item: AudioServiceItem.init(id: 1, url: url, title: ""))
//        } catch {
//            print(error)
//        }
    }
    ...
    private func updateRecorderConfiguration(_ configuration: RecorderConfiguration) -> RecorderConfiguration {
        ...
        configuration.isDefaultFrontCamera = true
