...
install_xcframework "${PODS_ROOT}/BanubaOverlayEditorSDK/BanubaOverlayEditorSDK.xcframework" "BanubaOverlayEditorSDK" "framework" "ios-x86_64-simulator" "ios-arm64"
