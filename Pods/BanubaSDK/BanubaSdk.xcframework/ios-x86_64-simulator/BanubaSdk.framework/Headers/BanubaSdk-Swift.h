...
SWIFT_CLASS("_TtC9BanubaSdk21EffectPlayerTouchView")
...
SWIFT_CLASS("_TtC9BanubaSdk14EffectTextArea")
@interface EffectTextArea : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


SWIFT_CLASS("_TtC9BanubaSdk12InputService")
...
@interface InputService (SWIFT_EXTENSION(BanubaSdk)) <AVCaptureAudioDataOutputSampleBufferDelegate, AVCapturePhotoCaptureDelegate, AVCaptureVideoDataOutputSampleBufferDelegate>
...
@interface InputService (SWIFT_EXTENSION(BanubaSdk))
